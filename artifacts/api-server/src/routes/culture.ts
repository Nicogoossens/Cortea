...
const MEHRABIAN_WEIGHTS: Record<string, MehrabianWeight> = {
  ...
  BG: { nonverbal: 30, tone: 40, words: 30, note: "Slavic Orthodox heritage, hospitality grounded in food and rakia, and quiet pride in being one of Europe's oldest continuous states." },
  UA: { nonverbal: 30, tone: 40, words: 30, note: "Resilience, hospitality, and pride in a 1,000-year cultural heritage centred on Kyiv — Ukraine sees itself as a European state with its own ancient identity." },
  CY: { nonverbal: 25, tone: 40, words: 35, note: "Mediterranean hospitality, deep Orthodox heritage, and pride in a 9,000-year continuously-inhabited island shaped by Phoenicians, Greeks, Romans, and more." },
  LU: { nonverbal: 35, tone: 25, words: 40, note: "Discreet European sophistication, multilingual openness, and pride in a small grand duchy that punches above its weight in EU institutions and finance." },
  PK: { nonverbal: 30, tone: 40, words: 30, note: "Generous hospitality, deep family loyalty, and pride in a Muslim civilisation that includes Mughal heritage and the Indus Valley." },
  MN: { nonverbal: 40, tone: 30, words: 30, note: "Nomadic pride, Buddhist heritage, and a deep cultural memory of being a world-empire — Mongolia sees itself as a steppe civilisation older than its modern borders." },
  BH: { nonverbal: 40, tone: 30, words: 30, note: "Pearl-trading mercantile heritage, refined Gulf hospitality, and the cosmopolitan tolerance of an island that has welcomed merchants for 5,000 years." },
  TN: { nonverbal: 25, tone: 40, words: 35, note: "Mediterranean Maghreb sophistication, layered Phoenician-Roman-Arab-French heritage, and the most secularised culture in the Arab world." },
  SN: { nonverbal: 35, tone: 40, words: 25, note: "Teranga — the Wolof concept of generous hospitality — combined with deep Sufi Islamic spirituality and pride in being French Africa's intellectual heart." },
  FJ: { nonverbal: 30, tone: 45, words: 25, note: "The Bula spirit — generous, gentle, communal warmth — combined with deep respect for chiefs, ancestors, and the vanua." },
