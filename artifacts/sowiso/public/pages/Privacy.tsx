...
import { Shield, Camera, Mic, MapPin, EyeOff, Eye, Trash2, CheckCircle2, Info, RefreshCw, LogIn } from "lucide-react";
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              />
              <ToggleRow
                label={t("privacy.remember_prefs")}
                description={t("privacy.remember_prefs_desc")}
                enabled={settings.rememberPreferences}
                onToggle={() => updateSetting("rememberPreferences", !settings.rememberPreferences)}
                icon={LogIn}
              />
            </CardContent>
          </Card>
