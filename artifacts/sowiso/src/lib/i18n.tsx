...
const STATIC_TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    "counsel.domains.greetings": "Greetings",
    "counsel.domains.dress_code": "Dress Code",
    "counsel.domains.conversation": "Conversation",
    "counsel.domains.gifting": "Gifting",
    "counsel.domains.other": "Other",
  ...
  nl: {
    ...
    "counsel.domains.greetings": "Begroeting",
    "counsel.domains.dress_code": "Kleding",
    "counsel.domains.conversation": "Gesprek",
    "counsel.domains.gifting": "Cadeau",
    "counsel.domains.other": "Overig",
  ...
  fr: {
    ...
    "counsel.domains.greetings": "Salutations",
    "counsel.domains.dress_code": "Tenue",
    "counsel.domains.conversation": "Conversation",
    "counsel.domains.gifting": "Cadeaux",
    "counsel.domains.other": "Autre",
  ...
  de: {
    ...
    "counsel.domains.greetings": "Begrüßung",
    "counsel.domains.dress_code": "Kleidung",
    "counsel.domains.conversation": "Gespräch",
    "counsel.domains.gifting": "Geschenk",
    "counsel.domains.other": "Sonstiges",
  ...
  es: {
    ...
    "counsel.domains.greetings": "Saludos",
    "counsel.domains.dress_code": "Vestimenta",
    "counsel.domains.conversation": "Conversación",
    "counsel.domains.gifting": "Regalos",
    "counsel.domains.other": "Otro",
  ...
  pt: {
    ...
    "counsel.domains.dining": "Mesa",
    "counsel.domains.greetings": "Saudações",
    "counsel.domains.dress_code": "Vestuário",
    "counsel.domains.conversation": "Conversa",
    "counsel.domains.gifting": "Presentes",
    "counsel.domains.other": "Outro",
  ...
  it: {
    ...
    "counsel.domains.greetings": "Saluti",
    "counsel.domains.dress_code": "Abbigliamento",
    "counsel.domains.conversation": "Conversazione",
    "counsel.domains.gifting": "Regali",
    "counsel.domains.other": "Altro",
  ...
  hi: {
    ...
    "counsel.domains.greetings": "अभिवादन",
    "counsel.domains.dress_code": "वस्त्र",
    "counsel.domains.conversation": "बातचीत",
    "counsel.domains.gifting": "उपहार",
    "counsel.domains.other": "अन्य",
