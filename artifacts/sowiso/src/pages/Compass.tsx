...
import { Compass as CompassIcon, Globe, Lock } from "lucide-react";
      ...
      <div className="space-y-4 max-w-3xl">
        ...
        {!allUnlocked && (
          <p className="text-xs font-mono uppercase tracking-widest text-muted-foreground border-l-2 border-muted pl-3">
            As a guest, one region is open to you.{" "}
            <Link href="/membership">
              <span className="text-primary cursor-pointer hover:underline underline-offset-2">Expand your world →</span>
            </Link>
          </p>
        )}
      </div>
