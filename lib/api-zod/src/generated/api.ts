...
export const GetProfileResponse = zod.object({
  ...
  subscription_tier: zod.enum(["guest", "basic", "student", "traveller", "ambassador", "founding"]),
...
export const UpdateProfileBody = zod.object({
  ...
  language_code: zod.string().optional(),
  active_region: zod.string().optional(),
  subscription_tier: zod.enum(["guest", "basic", "student", "traveller", "ambassador", "founding"]).optional(),
  calling_card_tagline: zod
    .string()
