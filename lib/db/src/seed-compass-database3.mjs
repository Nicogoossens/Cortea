...
const MD_PATH = resolve(ROOT, "attached_assets/Compas_database3_1777806590698.md");
const VENUES_OUT = resolve(ROOT, "artifacts/api-server/src/data/venues-extra2.ts");
const MEHRABIAN_OUT = resolve(ROOT, "lib/db/.tmp-mehrabian-extra2.txt");

// Only countries NOT already covered by seed-new-compass-countries.mjs.
const COUNTRY_CODES = {
  Lebanon: "LB",
  Oman: "OM",
  Kenya: "KE",
...
function writeVenuesFile(allVenues) {
  const header = `// AUTO-GENERATED by lib/db/src/seed-compass-database3.mjs — do not edit by hand.
// Source: attached_assets/Compas_database3_1777806590698.md
import type { Venue } from "./venues.js";

export const EXTRA_VENUES2: Venue[] = [
`;
