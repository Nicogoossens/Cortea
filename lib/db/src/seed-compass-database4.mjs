...
const MD_PATH = resolve(ROOT, "attached_assets/Compas_database4_1777807689008.md");
const VENUES_OUT = resolve(ROOT, "artifacts/api-server/src/data/venues-extra3.ts");
const MEHRABIAN_OUT = resolve(ROOT, "lib/db/.tmp-mehrabian-extra3.txt");

// Only countries from database4 NOT already covered by db1, db2 (seed-new-compass-countries),
...
function writeVenuesFile(allVenues) {
  const header = `// AUTO-GENERATED by lib/db/src/seed-compass-database4.mjs — do not edit by hand.
// Source: attached_assets/Compas_database4_1777807689008.md
import type { Venue } from "./venues.js";

export const EXTRA_VENUES3: Venue[] = [
`;
