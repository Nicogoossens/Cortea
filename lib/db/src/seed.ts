...
const protocols: (typeof cultureProtocolsTable.$inferInsert)[] = [
  ...
  // ── NETHERLANDS ───────────────────────────────────────────────────────────────
  // Pillar 1: Cultural Knowledge
  { region_code: "NL", pillar: 1, context: "social", rule_type: "Directness as Respect", rule_description: "Dutch directness is not rudeness — it is a sign of respect. Saying precisely what you mean, without softening or evasion, is considered the only honest way to communicate." },
  { region_code: "NL", pillar: 1, context: "social", rule_type: "Gezelligheid — The Art of Cosiness", rule_description: "Gezelligheid (convivial togetherness) is a foundational Dutch value. An atmosphere of warmth, ease, and good company is actively cultivated and deeply appreciated." },
  { region_code: "NL", pillar: 1, context: "social", rule_type: "Egalitarianism in All Things", rule_description: "The Netherlands has a profoundly flat social hierarchy. Pulling rank, name-dropping, or appealing to status is received with scepticism and mild contempt." },
  { region_code: "NL", pillar: 1, context: "business", rule_type: "Consensus Before Decision", rule_description: "Dutch organisations operate by consensus — the polder model. Decisions emerge from collective discussion. Attempting to bypass this process signals poor cultural awareness." },
  { region_code: "NL", pillar: 1, context: "social", rule_type: "Punctuality as Courtesy", rule_description: "Arriving on time is a basic social obligation. Being late without prior notice is considered disrespectful of others' time — a serious matter in Dutch culture." },
  // Pillar 2: Appearance
  { region_code: "NL", pillar: 2, context: "business", rule_type: "Understated Professional Dress", rule_description: "Dutch business dress tends toward the understated. Quality is valued over ostentation; a well-cut, conservative outfit will always serve better than conspicuous luxury." },
  { region_code: "NL", pillar: 2, context: "social", rule_type: "Practicality Over Fashion", rule_description: "Dutch dress culture prizes functionality. Cycling-appropriate clothing, sensible footwear, and weather-ready layering are not considered casual — they are considered sensible." },
  { region_code: "NL", pillar: 2, context: "formal", rule_type: "Formal Occasions Taken Seriously", rule_description: "When an occasion calls for formal dress, the Dutch take it precisely as stated. Arriving underdressed to a formal event signals disregard for the host's intentions." },
  { region_code: "NL", pillar: 2, context: "social", rule_type: "No Visible Logos", rule_description: "Conspicuous branding is viewed with suspicion in Dutch social contexts. Understated quality speaks more convincingly than the name on a label." },
  { region_code: "NL", pillar: 2, context: "business", rule_type: "Grooming Standards", rule_description: "Clean, neat, and well-maintained is the baseline expectation. Meticulous grooming signals self-respect and consideration for others without crossing into vanity." },
  // Pillar 3: Eloquence
  { region_code: "NL", pillar: 3, context: "social", rule_type: "First Names Quickly", rule_description: "The Dutch move to first names rapidly in almost all settings. Clinging to titles or surnames signals either formality or unfamiliarity with Dutch norms." },
  { region_code: "NL", pillar: 3, context: "business", rule_type: "Agenda-Led Meetings", rule_description: "Dutch meetings follow a structured agenda. Arriving without preparation or straying from the agenda without reason is considered a poor use of collective time." },
  { region_code: "NL", pillar: 3, context: "social", rule_type: "Criticism Is Constructive", rule_description: "Blunt feedback is a Dutch courtesy, not an attack. Receive criticism with equanimity and engage with it on its merits. Defensiveness will undermine your standing." },
  { region_code: "NL", pillar: 3, context: "social", rule_type: "Modesty in Self-Presentation", rule_description: "Boasting is deeply frowned upon. The Dutch expression 'doe maar gewoon, dan doe je al gek genoeg' (just act normally — that's crazy enough) captures the cultural expectation precisely." },
  { region_code: "NL", pillar: 3, context: "social", rule_type: "Eye Contact Signals Sincerity", rule_description: "Maintaining steady, direct eye contact while speaking signals honesty and engagement. Averting the gaze may be read as evasiveness or lack of confidence." },
  // Pillar 4: Table Manners
  { region_code: "NL", pillar: 4, context: "dining", rule_type: "Going Dutch — The Norm", rule_description: "Splitting the bill equally is the default expectation in the Netherlands. Insisting on paying for others can create awkwardness; paying only for yourself is perfectly correct." },
  { region_code: "NL", pillar: 4, context: "dining", rule_type: "Continental Cutlery Style", rule_description: "Fork in the left hand, knife in the right throughout the meal. Switching hands is not done in European dining convention." },
  { region_code: "NL", pillar: 4, context: "dining", rule_type: "Finishing Your Plate", rule_description: "Leaving food on the plate can suggest the food was unsatisfactory. Finishing your meal is a quiet compliment to the host's effort and hospitality." },
  { region_code: "NL", pillar: 4, context: "dining", rule_type: "Wait for the Host", rule_description: "Do not begin eating until the host invites you to start. A brief toast or 'eet smakelijk' (bon appétit) from the host signals the meal has begun." },
  { region_code: "NL", pillar: 4, context: "dining", rule_type: "Bring Something", rule_description: "When invited to a Dutch home for dinner, bring wine, flowers, or chocolates. Arriving empty-handed is considered poor form, even in informal settings." },
  // Pillar 5: Drinks
  { region_code: "NL", pillar: 5, context: "social", rule_type: "Jenever — The National Spirit", rule_description: "Jenever (Dutch gin) is a cultural institution. When offered, accept graciously. Familiarity with the distinction between jonge and oude jenever signals cultural awareness." },
  { region_code: "NL", pillar: 5, context: "social", rule_type: "Dutch Beer Culture", rule_description: "Beer — particularly lager — is the default social drink. Heineken, Grolsch, and Amstel carry cultural weight. Ordering confidently from the tap is always appropriate." },
  { region_code: "NL", pillar: 5, context: "dining", rule_type: "Wine at Dinner", rule_description: "Wine is widely appreciated at the Dutch dinner table. Bringing a good bottle when invited is a considered gesture; discussing it with enthusiasm is welcome." },
  { region_code: "NL", pillar: 5, context: "social", rule_type: "Coffee Culture", rule_description: "Coffee is the lubricant of Dutch social and professional life. Offering and accepting coffee is a ritual of hospitality. Refusing it without good reason can seem abrupt." },
  { region_code: "NL", pillar: 5, context: "social", rule_type: "Tipping Norms", rule_description: "Tipping in the Netherlands is appreciated but not obligatory — service is included in the price. Rounding up the bill or leaving a modest 10% for good service is entirely appropriate." },

  // ── PORTUGAL ─────────────────────────────────────────────────────────────────
  // Pillar 1: Cultural Knowledge
  { region_code: "PT", pillar: 1, context: "social", rule_type: "Saudade — The Emotional Landscape", rule_description: "Saudade — a bittersweet longing for what is absent — is the emotional undercurrent of Portuguese culture. Acknowledging it, even briefly, signals deep cultural understanding." },
  { region_code: "PT", pillar: 1, context: "social", rule_type: "Relationships Before Business", rule_description: "In Portugal, trust is built slowly and through personal connection. Business relationships require a foundation of genuine human rapport before meaningful transactions occur." },
  { region_code: "PT", pillar: 1, context: "social", rule_type: "Modest Restraint", rule_description: "Portuguese culture prizes modest restraint. Bragging, aggressive self-promotion, or conspicuous displays of wealth sit uncomfortably and are viewed with quiet suspicion." },
  { region_code: "PT", pillar: 1, context: "social", rule_type: "Religious and Cultural Sensitivity", rule_description: "Portugal has deep Catholic roots and a rich folk tradition. Showing respect for local religious customs, particularly during festivals and in churches, is essential." },
  { region_code: "PT", pillar: 1, context: "social", rule_type: "Punctuality — Flexible but Respected", rule_description: "Social engagements allow for modest lateness — arriving 15 minutes after the stated time is often normal. For professional appointments, however, punctuality is expected and valued." },
  // Pillar 2: Appearance
  { region_code: "PT", pillar: 2, context: "business", rule_type: "Conservative Business Dress", rule_description: "Business dress in Portugal tends toward the conservative and traditional. A well-tailored, understated ensemble conveys reliability and seriousness of intent." },
  { region_code: "PT", pillar: 2, context: "social", rule_type: "Smart Presentation in Social Settings", rule_description: "Portuguese social life values considered dress. Appearing well-turned-out — even at casual gatherings — signals respect for one's hosts and their invitation." },
  { region_code: "PT", pillar: 2, context: "formal", rule_type: "Formal Standards Upheld", rule_description: "When an occasion specifies formal attire, Portuguese convention takes this seriously. Formal events — weddings, galas, state occasions — call for precise, properly executed dress." },
  { region_code: "PT", pillar: 2, context: "social", rule_type: "Grooming and Presentation", rule_description: "Neatness and cleanliness are non-negotiable baseline standards. Well-kept clothing and careful grooming demonstrate self-respect and consideration for those around you." },
  { region_code: "PT", pillar: 2, context: "social", rule_type: "Understated Elegance", rule_description: "Understated elegance is the Portuguese aesthetic ideal. Quality of fabric and cut is valued over ostentation; a refined simplicity speaks more powerfully than a bold statement." },
  // Pillar 3: Eloquence
  { region_code: "PT", pillar: 3, context: "social", rule_type: "Forms of Address", rule_description: "Begin with Senhor/Senhora and the family name until invited to use given names. In professional contexts, titles are used with care and genuine respect." },
  { region_code: "PT", pillar: 3, context: "social", rule_type: "Earnest Hospitality", rule_description: "Portuguese hospitality is sincere and heartfelt. Receive it with genuine warmth and reciprocate with equal sincerity. Performative or perfunctory thanks are transparently hollow." },
  { region_code: "PT", pillar: 3, context: "social", rule_type: "Measured Communication", rule_description: "The Portuguese prefer a measured, thoughtful pace of conversation. Interrupting, speaking over others, or rushing to fill silence signals impatience rather than engagement." },
  { region_code: "PT", pillar: 3, context: "business", rule_type: "Avoid Confrontation", rule_description: "Direct confrontation is rarely the Portuguese way. Disagreements are navigated with tact, indirection, and a careful preservation of the other party's dignity." },
  { region_code: "PT", pillar: 3, context: "social", rule_type: "Fado as Cultural Heritage", rule_description: "Fado — Portugal's mournful musical soul — carries profound cultural significance. Listening attentively and responding with genuine emotion shows deep respect for the tradition." },
  // Pillar 4: Table Manners
  { region_code: "PT", pillar: 4, context: "dining", rule_type: "The Long Lunch", rule_description: "The midday meal in Portugal is often a lengthy, unhurried affair. Eating quickly and departing is considered gauche; the table is a place for conversation, not efficiency." },
  { region_code: "PT", pillar: 4, context: "dining", rule_type: "Bread Before the Meal", rule_description: "It is customary in Portuguese restaurants to place bread, olives, and small starters on the table. Note: these are charged individually — declining them politely is entirely acceptable." },
  { region_code: "PT", pillar: 4, context: "dining", rule_type: "Continental Cutlery Style", rule_description: "Table manners follow the continental European convention: fork in the left hand, knife in the right. Switching hands American-style is not done." },
  { region_code: "PT", pillar: 4, context: "dining", rule_type: "The Host Pays", rule_description: "When hosting a meal, the Portuguese tradition is that the host pays. An offer to contribute will typically be declined; the gesture itself, however, is appreciated." },
  { region_code: "PT", pillar: 4, context: "dining", rule_type: "Compliment Genuinely", rule_description: "Offering a specific, sincere compliment about the food or the host's table demonstrates attentiveness and gratitude. Vague or formulaic praise is noted as such." },
  // Pillar 5: Drinks
  { region_code: "PT", pillar: 5, context: "dining", rule_type: "Portuguese Wine — A Point of Pride", rule_description: "Portugal produces some of the finest wines in the world. Showing genuine curiosity about a Douro red or a Vinho Verde demonstrates cultural engagement that will be warmly appreciated." },
  { region_code: "PT", pillar: 5, context: "dining", rule_type: "Port Wine Protocol", rule_description: "Port wine is a Portuguese institution. Sip it with respect, allow the host to pour, and never rush it. A compliment on the vintage will always be received with pleasure." },
  { region_code: "PT", pillar: 5, context: "social", rule_type: "Ginjinha — The Cherry Liqueur", rule_description: "Ginjinha (cherry liqueur) is a beloved Portuguese social tradition, often served in a small chocolate cup. Accepting it graciously signals openness to local custom." },
  { region_code: "PT", pillar: 5, context: "social", rule_type: "Coffee After Every Meal", rule_description: "A small espresso (uma bica) after a meal is almost obligatory in Portuguese culture. Declining without good reason can seem abrupt; accepting signals social ease." },
  { region_code: "PT", pillar: 5, context: "social", rule_type: "Tipping Norms", rule_description: "Tipping is appreciated but not as mandatory as in North America. Rounding up the bill or leaving 5–10% for attentive service is a kind and welcome gesture." },

  // ── SOUTH AFRICA ─────────────────────────────────────────────────────────────
  // Pillar 1: Cultural Knowledge
  { region_code: "ZA", pillar: 1, context: "social", rule_type: "Ubuntu — I Am Because We Are", rule_description: "Ubuntu (umuntu ngumuntu ngabantu) is the philosophical foundation of South African social life. One's dignity and identity are bound up in community. Selfishness is a social failure." },
  { region_code: "ZA", pillar: 1, context: "social", rule_type: "Cultural Diversity with Respect", rule_description: "South Africa is one of the most culturally diverse nations on earth — Zulu, Xhosa, Afrikaner, Cape Malay, and many more. Demonstrating curiosity and genuine respect for each tradition is essential." },
  { region_code: "ZA", pillar: 1, context: "social", rule_type: "The Rainbow Nation Spirit", rule_description: "South Africa's post-apartheid identity celebrates diversity and reconciliation. Sensitivity to this history — and the progress since — is expected of any thoughtful guest." },
  { region_code: "ZA", pillar: 1, context: "social", rule_type: "Greetings Matter Deeply", rule_description: "Greeting people warmly and properly is a non-negotiable social courtesy in South Africa. A rushed or absent greeting signals disrespect; a full, unhurried acknowledgement opens every door." },
  { region_code: "ZA", pillar: 1, context: "business", rule_type: "Relationship Before Transaction", rule_description: "Particularly in communities shaped by African cultural traditions, business is preceded by relationship. Taking time to know your counterpart is not a pleasantry — it is a prerequisite." },
  // Pillar 2: Appearance
  { region_code: "ZA", pillar: 2, context: "business", rule_type: "Smart Professional Dress", rule_description: "Business settings expect smart professional attire. In corporate or formal contexts, a well-tailored suit commands respect; smart casual is acceptable in more relaxed industries." },
  { region_code: "ZA", pillar: 2, context: "social", rule_type: "Climate-Aware Dressing", rule_description: "South Africa's climate varies enormously — from Highveld heat to Cape coastal winds. Dressing practically and appropriately for the season and setting shows good sense." },
  { region_code: "ZA", pillar: 2, context: "formal", rule_type: "Traditional Attire Respected", rule_description: "When invited to events where traditional African attire is worn, dressing respectfully — and, if invited to participate, doing so with sincerity — is a mark of cultural honour." },
  { region_code: "ZA", pillar: 2, context: "social", rule_type: "Neat and Presentable Always", rule_description: "Regardless of the occasion's level of formality, clothing should be clean, well-maintained, and appropriate. Sloppiness signals a lack of respect for one's company." },
  { region_code: "ZA", pillar: 2, context: "social", rule_type: "Modest Dress in Traditional Communities", rule_description: "In more traditional or rural communities, particularly those shaped by Zulu or Xhosa cultural norms, modest dress — especially for women — is expected and should be observed without prompting." },
  // Pillar 3: Eloquence
  { region_code: "ZA", pillar: 3, context: "social", rule_type: "Greet in the Local Language", rule_description: "Attempting a greeting in Zulu ('Sawubona'), Xhosa ('Molo'), or Afrikaans ('Goeiedag') is warmly received and immediately signals goodwill and cultural interest." },
  { region_code: "ZA", pillar: 3, context: "social", rule_type: "Respectful Forms of Address", rule_description: "Use 'Mr', 'Mrs', or 'Dr' with the family name until invited to use a first name. Elder members of the community are addressed with particular deference." },
  { region_code: "ZA", pillar: 3, context: "social", rule_type: "Listen Before Speaking", rule_description: "In the Ubuntu tradition, listening attentively before offering one's own view is a mark of wisdom. Those who speak before they have listened are perceived as self-absorbed." },
  { region_code: "ZA", pillar: 3, context: "social", rule_type: "Avoid Racial Generalisations", rule_description: "South Africa's complex racial history demands heightened sensitivity. Generalisations — even well-intentioned ones — are received poorly and can cause lasting damage to a relationship." },
  { region_code: "ZA", pillar: 3, context: "business", rule_type: "Warmth in Professional Settings", rule_description: "South African professional culture values personal warmth alongside competence. A cold, purely transactional manner will be read as unfriendly rather than efficient." },
  // Pillar 4: Table Manners
  { region_code: "ZA", pillar: 4, context: "dining", rule_type: "The Braai — Sacred Ritual", rule_description: "The braai (barbecue) is not merely a meal — it is a social institution of the highest order. The person at the fire is the host and manager of the grill; do not interfere uninvited." },
  { region_code: "ZA", pillar: 4, context: "dining", rule_type: "Bring Something to the Braai", rule_description: "Arriving at a braai empty-handed is poor form. Bring meat, a salad, drinks, or dessert. Contributing to the communal feast is an expression of ubuntu and goodwill." },
  { region_code: "ZA", pillar: 4, context: "dining", rule_type: "Communal Dining in Traditional Settings", rule_description: "In traditional South African settings, food is often shared communally. Wait to be invited to eat, accept what is offered graciously, and express genuine appreciation." },
  { region_code: "ZA", pillar: 4, context: "dining", rule_type: "Right Hand for Food", rule_description: "In communities following Islamic or traditional African customs, passing and receiving food with the right hand demonstrates respect. Observe the practice of those around you." },
  { region_code: "ZA", pillar: 4, context: "dining", rule_type: "Tipping Expected", rule_description: "Tipping in South African restaurants is expected and important — service staff depend on it as part of their income. 10–15% is standard; 15–20% signals genuine satisfaction." },
  // Pillar 5: Drinks
  { region_code: "ZA", pillar: 5, context: "social", rule_type: "South African Wine — A National Treasure", rule_description: "The Cape Winelands produce world-class wines. Showing genuine interest in a Stellenbosch Cabernet or a Constantia Sauvignon Blanc demonstrates cultural attentiveness that will be appreciated." },
  { region_code: "ZA", pillar: 5, context: "social", rule_type: "Beer at the Braai", rule_description: "South African lager — Castle, Windhoek, or Black Label — is the default social drink at a braai. Accepting one signals easy sociability; declining politely for non-drinkers is entirely respected." },
